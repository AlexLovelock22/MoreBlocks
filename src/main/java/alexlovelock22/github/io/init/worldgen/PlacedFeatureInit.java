...
public class PlacedFeatureInit {
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, OVERWORLD_EXAMPLE_ORE_KEY, registryLookup.getOrThrow(ConfiguredFeatureInit.OVERWORLD_EXAMPLE_ORE_KEY),
                Modifiers.modifiersCount(19, HeightRangePlacementModifier.uniform(YOffset.fixed(-24), YOffset.fixed(100))));
    ...
    private static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, MoreBlocks.id(name));
    }
